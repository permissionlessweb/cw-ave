...
import { CwAveFactoryQueryClient, CwAveFactoryClient } from "./CwAveFactory.client";
...
export interface CwAveFactoryUpdateOwnershipMutation {
  client: CwAveFactoryClient;
  args?: {
...
export function useCwAveFactoryUpdateOwnershipMutation(options?: Omit<UseMutationOptions<ExecuteResult, Error, CwAveFactoryUpdateOwnershipMutation>, "mutationFn">) {
  return useMutation<ExecuteResult, Error, CwAveFactoryUpdateOwnershipMutation>(({
    client,
    msg,
    args: {
      fee,
...
export interface CwAveFactoryUpdateCodeIdMutation {
  client: CwAveFactoryClient;
  msg: {
...
export function useCwAveFactoryUpdateCodeIdMutation(options?: Omit<UseMutationOptions<ExecuteResult, Error, CwAveFactoryUpdateCodeIdMutation>, "mutationFn">) {
  return useMutation<ExecuteResult, Error, CwAveFactoryUpdateCodeIdMutation>(({
    client,
    msg,
    args: {
      fee,
...
export interface CwAveFactoryCreateNativeAvEventContractMutation {
  client: CwAveFactoryClient;
  msg: {
...
export function useCwAveFactoryCreateNativeAvEventContractMutation(options?: Omit<UseMutationOptions<ExecuteResult, Error, CwAveFactoryCreateNativeAvEventContractMutation>, "mutationFn">) {
  return useMutation<ExecuteResult, Error, CwAveFactoryCreateNativeAvEventContractMutation>(({
    client,
    msg,
    args: {
      fee,
  ...
  }) => client.createNativeAvEventContract(msg, fee, memo, funds), options);
}